...
export const sequelize = new Sequelize('mysql://root:meuhas@localhost:3306/winforms-cinema') // mysql connection
...
//Movie.belongsTo(Projection, {foreignKey: 'movie_id'})
//Projection.hasOne(Movie)
